using PagedList;
using PROGPOE.Areas.Admin.Models.ViewModels.Shop;
...
namespace PROGPOE.Areas.Admin.Controllers
{
  //  [Authorize(Roles = "Admin")]
    public class ShopController : Controller
    {
        ...
        public ActionResult AddProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            if (!ModelState.IsValid)
            {
                using (Db db = new Db())
                {
                    ...
                    {
                        model.Categories = new SelectList(db.Categories.ToList(), "Id", "Name");
                        ModelState.AddModelError("", "That product name is take!");
                        return View(model);
                    }
                }
            }
        ...
        //POST:Admin/Shop/SaveGallery/Images
        [HttpPost]
        ...
        public ActionResult Orders()
        {
            ...
            using (Db db = new Db())
            {
                ...
                foreach (var order in orders)
                {
                    ...
                    // Get address
                    UserDTO address = db.Users.Where(x => x.Id == order.UserId).FirstOrDefault();
            ...
            //return View with orders for admin models list.
